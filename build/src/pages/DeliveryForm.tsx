  ...
  return (
    <div className="space-y-6">
      <div className="flex items-start justify-between gap-4">
        ...
        <Link
          to="/delivery-plan"
          className="shrink-0 text-[10px] bg-red-500/10 hover:bg-red-500/20 text-red-400 border border-red-500/20 hover:border-red-500/40 px-3 py-2 rounded-lg tracking-wider uppercase font-bold transition-all whitespace-nowrap"
        >
          + Add Delivery Plan
        </Link>
      </div>
