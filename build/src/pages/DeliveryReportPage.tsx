                  ...
                  <div className="border border-black p-3 space-y-2">
                    ...
                    <table className="w-full text-[9px]">
                      ...
                      <tbody className="divide-y divide-neutral-200">
                        ...
                        <tr className="font-bold bg-neutral-50 border-t border-black text-[9.5px]">
                          <td>TOTAL HCS</td>
                          <td className="text-center">{splitCategories.hcs.totalTrips}</td>
                          <td className="text-center">{splitCategories.hcs.totalQty}</td>
                          <td className="text-right">{splitCategories.hcs.totalVol}</td>
                          <td className="text-right">{splitCategories.hcs.totalWt}</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
